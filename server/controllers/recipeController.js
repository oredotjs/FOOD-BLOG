...
exports.homepage = async (err, res, req) => {
  try {
    ...
    const lastestRecipe = await Recipe.find({}).sort({ _id: -1 }).limit(limit);
    ...
    const food = { lastestRecipe, american, thai, chinese };
...
exports.exploreCategoryById = async (req, res, next) => {
  try {
    limit = 20;
